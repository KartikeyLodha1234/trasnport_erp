...
var r, i;
var c = "undefined" != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", a = "active", l = "data-styled-version", u = "6.4.3", h = "/*!sc*/\n", d = "undefined" != typeof window && "undefined" != typeof document;
function p(e) {
...
var Ve = (e) => null == e || !1 === e || "" === e, Me = Symbol.for("react.client.reference");
function Ge(e) {
	return e.$$typeof === Me;
}
function Fe(e) {
...
var Xe = new _e(), Ke = Je(), Qe = import_react.createContext({
...
var $t = /:(?:(first)-child|(last)-child|(only)-child|(nth-child)\(([^()]+)\)|(nth-last-child)\(([^()]+)\))/g, Rt = `:not(style[${c}])`, jt = `style[${c}]`;
function xt(e) {
