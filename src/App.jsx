...
import ChallanHistory from "../web/src/pages/admin/Delivery/ChallanHistory.jsx";
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route
            path="/home/live-map"
            element={ProtectedRouteWithLayout(LiveMap)}
          />
          <Route
            path="/home/fleet-status"
            element={ProtectedRouteWithLayout(FleetStatus)}
          />

          {/* Shipment Routes */}
          <Route
            path="/shipments"
            element={ProtectedRouteWithLayout(AllShipments)}
          />
          <Route
            path="/shipments/create"
            element={ProtectedRouteWithLayout(CreateLR)}
          />
          <Route
            path="/shipments/delayed"
            element={ProtectedRouteWithLayout(DelayedShipments)}
          />
          <Route
          ...
          <Route
            path="/delivery"
            element={ProtectedRouteWithLayout(() => (
          ...
          {/* ⚡ ADDED CHALLAN HISTORY ROUTE HERE ⚡ */}
          <Route
            path="/delivery/history"
            element={ProtectedRouteWithLayout(ChallanHistory)}
          />
          ...
          <Route
            ...
            element={ProtectedRouteWithLayout(() => (
              <div>Accounts Overview Page</div>
            ))}
          />
          <Route
            path="/accounts/transactions"
            element={ProtectedRouteWithLayout(Transactions, {
              requiredRole: "admin",
            })}
          />
          <Route
            ...
            element={ProtectedRouteWithLayout(() => (
              <div>Receivables Page</div>
            ))}
          />
          <Route
            path="/accounts/payables"
            element={ProtectedRouteWithLayout(() => (
              <div>Payables Page</div>
            ))}
          />
          ...
          <Route
            ...
            element={ProtectedRouteWithLayout(() => (
              <div>Operational Report Page</div>
            ))}
          />
          <Route
            path="/reports/custom"
            element={ProtectedRouteWithLayout(() => (
              <div>Custom Report Page</div>
            ))}
          />
          ...
          <Route
            ...
            element={ProtectedRouteWithLayout(VehicleList, {
              requiredRole: "admin",
            })}
          />
          <Route
          ...
          <Route
            ...
            element={ProtectedRouteWithLayout(VehicleView, {
              requiredRole: "admin",
            })}
          />
          <Route
            path="/vehicle-edit/:id?"
            element={ProtectedRouteWithLayout(VehicleEdit, {
              requiredRole: "admin",
            })}
          />
          <Route
            path="/masters/drivershow"
            element={ProtectedRouteWithLayout(DriverShow, {
              requiredRole: "admin",
            })}
          />
          <Route
          ...
          />
          <Route path="/profile" element={ProtectedRouteWithLayout(Profile)} />
          <Route
            path="/wallet"
            element={ProtectedRouteWithLayout(AdminWallet)}
          />
          <Route
